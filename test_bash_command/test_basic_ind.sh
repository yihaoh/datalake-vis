...
# santos as default
pytest tests/test_basic_complete.py --vis_ins basic_ind --N 10 --threshold 0.2 --result_path data/santos/basic_results -s
pytest tests/test_basic_complete.py --vis_ins basic_ind --N 20 --threshold 0.2 --result_path data/santos/basic_results -s
pytest tests/test_basic_complete.py --vis_ins basic_ind --N 30 --threshold 0.2 --result_path data/santos/basic_results -s
pytest tests/test_basic_complete.py --vis_ins basic_ind --N 40 --threshold 0.2 --result_path data/santos/basic_results -s
pytest tests/test_basic_complete.py --vis_ins basic_ind --N 50 --threshold 0.2 --result_path data/santos/basic_results -s