...
# santos as default
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 10 --threshold 0.2 --result_path data/santos/opt_results -s
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 20 --threshold 0.2 --result_path data/santos/opt_results -s
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 30 --threshold 0.2 --result_path data/santos/opt_results -s
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 40 --threshold 0.2 --result_path data/santos/opt_results -s
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 50 --threshold 0.2 --result_path data/santos/opt_results -s