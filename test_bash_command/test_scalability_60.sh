...
pytest tests/test_opt_perf_complete.py --vis_ins opt_perf --N 10 --threshold 0.2 \
                                    --table_search_result_path data/open_data_60/tus_results \
                                    --query_path data/open_data_60/query_new \
                                    --datalake_path data/open_data_60/datalake_new \
                                    --orig_query_path data/open_data_60/query \
                                    --orig_datalake_path data/open_data_60/datalake \
                                    --result_path data/open_data_60/opt_results -s
